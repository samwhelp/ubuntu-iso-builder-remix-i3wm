...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-remix-i3wm/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-remix-i3wm/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-remix-i3wm/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-remix-i3wm](https://github.com/samwhelp/ubuntu-iso-builder-remix-i3wm)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-remix-i3wm.git
```


> change dir to `ubuntu-iso-builder-remix-i3wm`

``` sh
cd ubuntu-iso-builder-remix-i3wm
```
...
> change dir to `~/work/ubuntu-iso-builder-remix-i3wm/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-remix-i3wm/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-remix-i3wm/iso-profile/dist`
